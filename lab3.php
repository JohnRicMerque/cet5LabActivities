    ...
    <div class="content">
        ...
        <main>
            ...
            <?php 
                    ...
                    echo '<tr><td>1f. ', implode(', ', $myarray), '</td><td>', var_dump($myarray), '</td></tr>';
                    echo '</table>'
                
            ?>

            <h3>2. PHP Arithmetic Operators</h3>
            <?php 
                    echo '<table width="95%" border=1 style="border-collapse: collapse;">';
            ...
            <h3>4.PHP Comparison Operators</h3>
            <?php 
                    echo '<table width="95%" border=1 style="border-collapse: collapse;">';
